    ...
    if table_str in table_str:
        ...
        for product in reps:
            ...
            row = {
                ...
                'Rmrk_1': product['Rmrk_1'],
                'Rmrk_2': product['Rmrk_2'],
                'Rmrk_3': product['Rmrk_3'],
                ...
                'Mix_PD_And_Brnd_Dsc': product['Mix_PD_And_Brnd_Dsc'],
                ...
                'Per_Txn_LwrLmtAmt': Per_Txn_LwrLmtAmt,
